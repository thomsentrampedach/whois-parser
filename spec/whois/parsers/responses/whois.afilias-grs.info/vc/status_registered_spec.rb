...
describe Whois::Parsers::WhoisAfiliasGrsInfo, "status_registered.expected" do
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2018-05-28 09:45:27 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2019-06-29T00:58:18Z UTC"))
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].id).to eq("C18177476-AGRS")
  ...
  describe "#admin_contacts" do
    it do
      ...
      expect(subject.admin_contacts[0].id).to eq("C18177476-AGRS")
  ...
  describe "#technical_contacts" do
    it do
      ...
      expect(subject.technical_contacts[0].id).to eq("C18177476-AGRS")
