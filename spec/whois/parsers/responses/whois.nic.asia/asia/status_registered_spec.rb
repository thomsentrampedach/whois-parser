...
describe Whois::Parsers::WhoisNicAsia, "status_registered.expected" do
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2018-01-15 22:23:56 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2019-01-15 11:28:02 UTC"))
    end
  end
  describe "#registrar" do
    it do
      ...
      expect(subject.registrar.name).to eq("dotASIA")
      expect(subject.registrar.organization).to eq("dotASIA")
